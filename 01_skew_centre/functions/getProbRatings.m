...
global screenID win ftmVal boxVal1 boxVal2 boxVal3 boxVal4 boxVal5 boxVal6 boxVal7 boxVal8 % new global variables
...
if strcmp(stimType,'highRank')
    nOuts = 8;
        labelText = {'    0 points -->','  10 points -->','  20 points -->','  30 points -->','  40 points -->','  50 points -->','  60 points -->','100 points -->'};

elseif strcmp(stimType,'lowRank')
    nOuts = 8;

        labelText = {'    0 points -->','  40 points -->','  50 points -->','  60 points -->','  70 points -->','  80 points -->','  90 points -->','100 points -->'};

end

% Button variables
buttXpos = [repelem(centerHor - 105, 4), repelem(centerHor + 295, 4)];
...
buttYpos = [100 + centerVert + ((1:4) - 3)*buttOffset, 100 + centerVert + ((1:4) - 3)*buttOffset];
            ...
            if buttons(1,1) %left button->choosing
                ...
                if whichNode > 0
                    ...
                    if whichNode == size(buttRects,2) % clicked Proceed button
                        ...
                        elseif nOuts == 8
                            respVals = [str2num(boxVal1), str2num(boxVal2), str2num(boxVal3), str2num(boxVal4), str2num(boxVal5), str2num(boxVal6), str2num(boxVal7), str2num(boxVal8)];
                        end
