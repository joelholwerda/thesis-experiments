...
Column 1:	MagLevel (1 = 1; 2 = 100)
Column 2:   Shared/Nonshared
Column 3:	Trial Number
Column 4:	Block Number
Column 5:	Trial in Block
Column 6:	Trial Type (1 = 'G'; 2 = 'L'; 3 = 'C'; 4 = 'S')
Column 7:	stimA: stimulus presented on the left hand side of screen (see Stimulus key above)
Column 8:	stimB: stimulus presented on the right hand side of screen (see Stimulus key above)
Column 9:	outcome associated with stimulus A (see Stimulus key above)
Column 10: 	outcome associated with stimulus B (see Stimulus key above)
Column 11:	Option chosen (1 = Stimulus A; 2 = Stimulus B)
Column 12:	Feedback provided (outcome for option chosen)
Column 13:	Reaction time
