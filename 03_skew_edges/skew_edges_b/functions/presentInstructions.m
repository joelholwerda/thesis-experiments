...
instructStr{1} = 'In this experiment, you will be presented with four different coloured squares: red, yellow, green, and blue. \n Clicking on a coloured square will result in winning a number of points (depending on the one you choose).';
...
instructStr{4} = 'Following the experiment, the outcome of one choice will be randomly selected. \n You will be given $1 for every ten points earned from that choice.';
