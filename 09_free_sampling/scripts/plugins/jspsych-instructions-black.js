jsPsych.plugins['instructions-black'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-black',
    description: '',
    parameters: {
      pages: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      var html = "<div id='instructions-black' class='bandit-screens'>";
        
        html += "<div class=jspsych-instructions-text-black>";
      ...
      if (trial.show_clickable_nav) {
        ...
        html += "<button id='jspsych-instructions-next' class='next-button hidden hvr-grow' draggable='false'>"+trial.button_label_next+"</button></div>";
