...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += "ul.jspsych-survey-likert-opts {padding: 0px}"+
      ".likert-container { width:650px; margin-top:150px; padding-bottom:50px; padding-top: 20px}"+
      ".jspsych-survey-likert-preamble { position:fixed; top:0px; left:50%; transform:translateX(-50%); width: 650px; height:180px; background:white; padding-top:60px; padding-bottom: 30px; margin-bottom: 20px; border-bottom: 3px solid grey; font-size: 140%; z-index:10; }"+
      ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 15px; margin-bottom:20px; }"+
      ".jspsych-survey-likert-opts { list-style:none; width:500px; margin-left:auto; margin-right:auto; padding:0px, 0px, 0px, 0px; display:block; font-size: 14px; line-height:1.1em; }"+
      ".jspsych-survey-likert-opt-label { line-height: 1.1em; color: #444; padding-top: 10px;}"+
      ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; /*left:9.5%;*/ display:block; background-color:#efefef; height:4px; width:100%; }"+
      ".jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }"+
      ".jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }"+
      ".jspsych-survey-likert-opts li input[type=radio] { display:block; position:relative; top:0; left:50%; margin-left:-6px; }"+
      ".jspsych-display-element { display: flex; flex-direction: column; overflow-y: auto; overflow-x: hidden;}"+
      ".jspsych-display-element:focus { outline: none;}"+
      ".jspsych-content-wrapper { display: flex; margin: auto; flex: 1 1 100%; width: 100%;}"+
      ".jspsych-content { text-align: center; margin: auto; }"
      html += '</style>';
    ...
    // add submit button
    html += '<input type="submit" id="jspsych-survey-likert-next" class="jspsych-survey-likert jspsych-btn btn btn-outline-primary" value="'+trial.button_label+'"></input>';
