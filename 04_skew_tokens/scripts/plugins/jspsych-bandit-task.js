  ...
  plugin.info = {
    ...
    parameters: {
      ...
      outcomes1: {
        ...
        default_value: undefined,
        description: "Possible outcomes (number of points) for selecting Option 1."
      },
      option2: {
        type: jsPsych.plugins.parameterType.STRING,
      ...
      outcomes2: {
        ...
        default_value: undefined,
        description: "Possible outcomes (number of points) for selecting Option 2."
      },
      prob1: {
        type: jsPsych.plugins.parameterType.FLOAT,
        pretty_name: "Option 1 Outcomes Probabilities",
        default_value: null,
        description: "Probabilities associated with Option 1 outcomes. Must be an array of the same length as outcomes1."
      },
      prob2: {
        type: jsPsych.plugins.parameterType.FLOAT,
        pretty_name: "Option 2 Outcomes Probabilities",
        default_value: null,
        description: "Probabilities associated with Option 2 outcomes. Must be an array of the same length as outcomes2."
      },
      singleOption: {
